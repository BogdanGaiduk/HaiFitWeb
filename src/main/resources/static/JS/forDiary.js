...
var _Calendar=function(){
    var _Calendar={
        ...
        cs_over:function(e){
            _Calendar.evtTgt(e).style.background='#00FF6E';
        },
    ...
    s+="\n"+'<tr style="background:#00FF6E;font:12px Arial;color:#000000"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>';
    ...
    s+='<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#00FF6E" onclick="_Calendar.today()">Сегодня: '+_Calendar.addnull(_Calendar.sccd,_Calendar.sccm+1,_Calendar.sccy)+'</td></tr>';
    tbl.innerHTML=s;
